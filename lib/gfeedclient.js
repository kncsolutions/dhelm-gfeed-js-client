...
var DhelmGfeed = function(params) {
    ...
    this.getExchanges=function(callback){
        ...
        if(!LOCK_GET_EXCHANGES){
            function_list["function"].push(1);
            function_list["callback"].push(callback);
            function_list["params"].push({"param":"no_params"});
            ...
            if(Authenticated) {
                ...
                if(e!=null){
                     if(e.data.includes('"MessageType":"'+constants.MESSAGE_EXCHANGE_RESULT+'"') ){
                            ...
                            if(callback){
                                function_list["function"].splice( function_list["function"].indexOf(1), 1 );
                                function_list["callback"].splice( function_list["callback"].indexOf(callback), 1 );
                                function_list["params"].splice( function_list["params"].indexOf('{"param":"no_params"}'), 1 );
